...
| :--- | :--- | :--- |
| **🎧 [Sonic Hit Predictor](https://github.com/lucytheboss/Sonic-Analytics-Hit-Predictor)**<br>_AI Audio Analysis Dashboard_ | **Streamlit**, **Librosa**, Random Forest, Plotly | Built an interactive web app that extracts audio features (BPM, Energy) to predict song popularity and provides actionable "Doctor's Orders" for optimization. |
